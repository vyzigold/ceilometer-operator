...
func (in *Ceilometer) DeepCopyInto(out *Ceilometer) {
	*out = *in
	...
	in.MysqldExporterStatus.DeepCopyInto(&out.MysqldExporterStatus)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MysqldExporterStatus) DeepCopyInto(out *MysqldExporterStatus) {
	*out = *in
	if in.Hash != nil {
		in, out := &in.Hash, &out.Hash
		*out = make(map[string]string, len(*in))
	...
	if in.ExportedGaleras != nil {
		in, out := &in.ExportedGaleras, &out.ExportedGaleras
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MysqldExporterStatus.
func (in *MysqldExporterStatus) DeepCopy() *MysqldExporterStatus {
	if in == nil {
		return nil
	}
	out := new(MysqldExporterStatus)
	in.DeepCopyInto(out)
	return out
}
